                                    ...
                                    <div class="row">
                                      <div class="col-md-12" style="margin-top: 20px">
                                        ...
                                        <p style="text-align:center;font-family: Poppins;font-style: normal;font-weight: 500;font-size: 14px;line-height: 21px;color: #3B97D3;">
                                          <!--  > -->
                                          <a href="https://play.google.com/store/apps/details?id=com.maungaji&hl=in&gl=US" target="_blank">yuk belajar dengan ustadz/ah  <?php echo $list['teacher']['name']; ?> di aplikasi maungaji <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                                        </p>
                                      </div>
                                    </div>
                                  </div>
